#pragma once
#ifndef ANDRES_GRAPH_ILP_HXX
#define ANDRES_GRAPH_ILP_HXX
...
multicut_ilp(
    ...
    ArrayProxy<char> labels_proxy(edgeLabel_ptr);


    andres::graph::multicut::ilp<andres::ilp::Gurobi>(graph, weights, labels_proxy, labels_proxy);
}

#endif //ANDRES_GRAPH_ILP_HXX