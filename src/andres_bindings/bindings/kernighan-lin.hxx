#pragma once
#ifndef ANDRES_GRAPH_KERNIGHAN_LIN_HXX
#define ANDRES_GRAPH_KERNIGHAN_LIN_HXX
...
kernighan_lin(
    ...
    andres::graph::multicut::kernighanLin(graph, weights, edgeLabel_ptr, edgeLabel_ptr);
}


#endif //ANDRES_GRAPH_KERNIGHAN_LIN_HXX